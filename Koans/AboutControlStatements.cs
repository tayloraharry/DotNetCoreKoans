...
namespace DotNetCoreKoans.Koans
{
    public class AboutControlStatements : Koan
    {
        ...
        public void ContinueStatement()
        {
            ...
            Assert.Equal(new List<int>(new[] {1, 3, 5, 7, 9}), result);
        }
        ...
        public void ForStatement()
        {
            ...
            Assert.Equal(new List<string>(new[] {"FISH", "AND", "CHIPS"}), list);
        }
        ...
        public void ForEachStatement()
        {
            ...
            Assert.Equal(new List<string>(new[] {"fish", "and", "chips"}), list);
            Assert.Equal(new List<string>(new[] {"FISH", "AND", "CHIPS"}), finalList);
        }
